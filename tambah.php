...
//Memeriksa koneksi ke database			
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO mahasiswa(npm, nama) VALUES('$npm', '$nama')") or die(mysqli_error($koneksi));
...
<!-- Mengirim data yang dimasukkan ke dalam database -->		
