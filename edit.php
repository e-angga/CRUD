<!-- Memanggil file konek.php -->
<?php include('konek.php'); ?>
<!DOCTYPE html>
<html>
<head>
	<title>LSP CRUD</title>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			<a class="navbar-brand" href="#">LSP CRUD</a>
...
<!-- Membuat Form Edit Data -->		
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			$nama			= $_POST['nama'];
			$sql = mysqli_query($koneksi, "UPDATE mahasiswa SET nama='$nama' WHERE id='$id'") or die(mysqli_error($koneksi));
		...
		?>
<!-- Mengirim data yang diubah ke dalam database -->			
